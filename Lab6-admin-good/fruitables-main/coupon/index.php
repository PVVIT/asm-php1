...
{
    global $dbHelper;
    $sql = $dbHelper->select("SELECT * FROM coupon  WHERE code = '$code'");
    if (count($sql) > 0) {
        return false;
    } else {
        return true;
    ...
    if (!isset($_POST["name"]) || empty($_POST['name'])) {
        ...
        if (!empty($_POST['code'])) {
            if (!checkCode($_POST['code'])) {
                ...
                $codeValid = $dbHelper->insert('coupon', array(
                    'name' => $_POST['name'],
                    'code' => $_POST['code'],
...
<body>
    ...
    <div class="container mt-3">
        ...
        <form action="index.php" method="post">
            ...
            <input type="date" name="starDate" class="form-control mt-3" required placeholder="ngày bắt đầu">
            ...
            <a href="../carts/cart.php" class="btn btn-danger mt-3">Cart</a>
        ...
        <table class="table">
            ...
            $counpons = $dbHelper->select("select * from coupon");
