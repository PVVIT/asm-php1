                         ...
                         <form action="add-user.php" method="post">
                              ...
                              <div class="mb-3">
                                   ...
                                   if (isset($errors['username'])) {
                                        echo "<span class='text-danger' style='font-size: 15px; padding-left: 14px'>$errors[username]</span>";
                                   }
                                   ?>
                              </div>
                              <div class="mb-3">
                                   ...
                                   if (isset($errors['email'])) {
                                        echo "<span class='text-danger' style='font-size: 15px; padding-left: 14px'>$errors[email]</span>";
                                   }
                                   ?>
                              </div>
                              <div class="mb-3">
                                   ...
                                   if (isset($errors['phone'])) {
                                        echo "<span class='text-danger' style='font-size: 15px; padding-left: 14px'>$errors[phone]</span>";
                                   }
                                   ?>
                              </div>
                              <div class="mb-3">
